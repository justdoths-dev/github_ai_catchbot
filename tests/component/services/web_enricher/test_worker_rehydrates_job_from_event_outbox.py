...
from services.web_enricher.models import ArtifactEnrichmentJob
from services.web_enricher.redis_streams import StreamMessage
...
async def test_worker_uses_trigger_event_id_to_rehydrate_before_ack() -> None:
    ...
    worker = WebEnricherWorker(_config(), consumer=consumer, service=service)
...
@pytest.mark.asyncio
async def test_repository_rehydrates_web_job_from_event_outbox() -> None:
    trigger_event_id = uuid4()
