...
def test_permission_module_imports_without_db_redis_or_network_connection(monkeypatch) -> None:
    calls: list[str] = []
    module_name = "scripts.ops.collector_sensitive_path_permission_check"
...
def test_schema_report_generation_passes_against_current_repo_root() -> None:
    module = importlib.import_module("scripts.ops.collector_sensitive_path_permission_check")
