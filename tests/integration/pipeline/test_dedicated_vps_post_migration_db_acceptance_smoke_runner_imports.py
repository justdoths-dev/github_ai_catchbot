...
def test_dedicated_vps_post_migration_db_acceptance_smoke_runner_imports_successfully() -> None:
    module = importlib.import_module("scripts.ops.dedicated_vps_post_migration_db_acceptance_smoke_runner")
