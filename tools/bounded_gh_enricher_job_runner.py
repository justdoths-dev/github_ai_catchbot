...
from src.services.gh_enricher.bounded_github_enrich_runner import (
    ...
    BoundedGithubEnrichDatabaseBuilder,
    BoundedGithubEnrichRedisBuilder,
    BoundedGithubEnrichResult,
    BoundedGithubEnrichRuntimeConfig,
    argument_error_report,
    render_sanitized_json,
    run_bounded_github_enrich_sync,
)
...
def build_parser() -> argparse.ArgumentParser:
    parser = JsonOnlyArgumentParser(
        description="Process exactly one target q.artifact.enrich.github job.",
        add_help=False,
    )
...
def run(
    ...
    *,
    ...
    result = run_bounded_github_enrich_sync(
        BoundedGithubEnrichConfig(
            ...
            allow_github_read=bool(args.allow_github_read),
