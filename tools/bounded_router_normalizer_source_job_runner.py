...
from src.services.router_normalizer.bounded_source_normalize_runner import (
    ...
    BoundedSourceNormalizeDatabaseBuilder,
    BoundedSourceNormalizeRedisBuilder,
    BoundedSourceNormalizeResult,
    BoundedSourceNormalizeRuntimeConfig,
    argument_error_report,
    render_sanitized_json,
    run_bounded_source_normalize_sync,
)
...
def build_parser() -> argparse.ArgumentParser:
    parser = JsonOnlyArgumentParser(
        description="Process exactly one target q.source.normalize router-normalizer job.",
        add_help=False,
    )
...
def run(
    ...
    *,
    ...
    result = run_bounded_source_normalize_sync(
        BoundedSourceNormalizeConfig(
